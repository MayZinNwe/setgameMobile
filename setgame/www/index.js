...
function showCurrentGame() {
    if (currentGame) {
        ...
        $.getJSON("http://"+ ipaddr +"/setgame/api/cardsOnTable/getTableCards/?id=" + currentGame)
                .done(function (data) {
...
function showAllExistingGames() {
    $.getJSON("http://"+ ipaddr +"/setgame/api/game/getExistingGames/")
            .done(function (data) {
...
function createNewGame(game) {
    $.getJSON("http://"+ ipaddr +"/setgame/api/game/createNewGame/")
            .done(function (game) {
                addNewGameItem(game);
...
function checkGameRules(id) {
    ...
    if (selectedCount === 3) {
        $.getJSON("http://"+ ipaddr +"/setgame/api/cardsOnTable/checkTableCards/?id=" + currentGame
...
$(function () {
    $("#btnHint").on("click", function () {
        $.getJSON("http://"+ ipaddr +"/setgame/api/game/getAllCards/")
                .done(function (data) {
                    // To clear all rows inside the table
                    $("#hintTable").empty();
                    // Add row based on return data
    ...
    $("#btnShuffle").on("click", function () {
        $.getJSON("http://"+ ipaddr +"/setgame/api/game/getShuffleCards/")
                .done(function (data) {
